...
<table>
     <tr>
            <td>First Name</td>
            <td><input type="text" name="first_name" id="first_name" value="<?=$_REQUEST['first_name']?>" required/></td>
          </tr>
          <tr>
            <td>Last Name</td>
            <td><input type="text" name="last_name" id="last_name"  value="<?=$_REQUEST['last_name']?>" required/></td>
          </tr>
     <tr>
              ...
              <!--<select name="country" id="country" style="width:100px;">
                   ...
                   <?php
                       global $wpdb;			
                        ...
                        {
                    ?>	
                    <option value="<?=$arr[$i]->iso2?>"  <?php if($_REQUEST['country']==$arr[$i]->iso2){ echo "selected";}?>><?=$arr[$i]->short_name?></option>
                   <?php
                        }
                   ?>
                </select>-->
              <select id="country" style="width:100px;" name="country">
                <option value="">Select Country</option>
     ...
     <tr>
        ...
        <td>
            <input name="adress1" value="<?=$_REQUEST['adress1']?>" placeholder="Please enter your address" type="text"   tabindex="7" required>
			<input name="adress2" value="<?=$_REQUEST['adress2']?>"  type="text" tabindex="8">
        </td>
     </tr>
     <tr>
        <td><span>City: *</span>
        </td>
        <td><input name="city"  value="<?=$_REQUEST['city']?>"  type="text" placeholder="Please enter city name" tabindex="9" required>
        </td>
     </tr>
     <tr>
        <td><span>State: *</span>
        </td>
        <td><input name="state"  value="<?=$_REQUEST['state']?>"  type="text"  placeholder="Please enter state" tabindex="10">
        </td>
     </tr>
     <tr>
        <td><span>Postal Code: *</span>
        </td>
        <td><input name="zip_code"  value="<?=$_REQUEST['zip_code']?>"  type="text"   placeholder="Enter zip/postal code" tabindex="11">
        </td>
     </tr>
</table>
...
<table width="50%">
  <tr>
      ...
      <td>
         <select name="card_type" id="card_type" tabindex="12">
  ...
  <tr>
      ...
      <td>
          <input type="text" name="card_number"  value="<?=$_REQUEST['card_number']?>"  placeholder="Enter credit card number"  maxlength=16 tabindex="13" required>
      </td>
  </tr>
  <tr>
  ...
  <tr>
      ...
      <td><input name="verification_code"  value="<?=$_REQUEST['verification_code']?>"  type="text" class="short" placeholder="Enter CVV" pattern="\d*" tabindex="16" required>
      </td>
  </tr>	
  <tr>
      <td> 
      ...
      <td>
		  ...
		  ?>
          <input type="hidden" name="payment_amuont" value="<?=number_format($total+$tax+$shipping_charge, 2, '.','')?>" />
		  ...
		  else
		  {
			 ...
			 $guid = $page->guid; 
		  ?>
          <a href="<?=$guid?>">Please login first to submit your order</a>
          <?php
		  }
		  ?>
      </td>
